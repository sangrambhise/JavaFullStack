package com.wipro.uberservice.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, RideRequest> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.wipro.shared.dto");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.wipro.shared.dto.RideRequest");
    ...
    public KafkaTemplate<String, RideRequest> uberKafkaTemplate() {
